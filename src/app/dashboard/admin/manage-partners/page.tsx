...
export default function ManagePartners() {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    className="h-12 mt-2 border-2 border-gray-200 focus:border-purple-500 transition-all"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    <SelectTrigger className="h-12 mt-2 border-2 border-gray-200 focus:border-purple-500 bg-white transition-all">
                      <SelectValue placeholder="Select partner type" />
                    </SelectTrigger>
                    <SelectContent className="max-h-60 bg-white border border-gray-200 shadow-lg z-[100]">
                      <SelectItem value="ngo" className="py-3 px-4 hover:bg-green-50 cursor-pointer">
                        🌱 NGO
                      </SelectItem>
                      ...
                      <SelectItem value="financial" className="py-3 px-4 hover:bg-yellow-50 cursor-pointer">
                        💰 Financial
                      </SelectItem>
                ...
                <div>
                  <Label htmlFor="areaOfCollaboration" className="text-sm font-semibold text-gray-700">
              ...
              <div>
                <Label htmlFor="termsSummary" className="text-sm font-semibold text-gray-700">
                  Terms Summary
                </Label>
                <Textarea
                  id="termsSummary"
                  ...
                  className="mt-2 border-2 border-gray-200 focus:border-purple-500 transition-all"
                  rows={4}
                />
              </div>
  ...
  <CardHeader className="bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-t-lg">
    ...
    <CardDescription className="text-orange-100 text-base">Manage existing partners</CardDescription>
  </CardHeader>
      ...
      <div className="space-y-0">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 font-medium text-lg">No partners yet</p>
            <p className="text-sm text-gray-400 mt-2">Add your first partner to get started</p>
          </div>
        ) : (
          partners.map((partner, index) => (
            <div
              key={partner._id}
              className={`p-6 border-b ${index % 2 === 0 ? "bg-gray-50" : "bg-white"} hover:bg-orange-50 transition-colors`}
            >
              <div className="flex items-start justify-between flex-wrap">
                {/* LEFT BLOCK */}
                <div className="flex-1 min-w-[250px]">
                  <div className="flex items-center flex-wrap gap-2 mb-3">
                    <h4 className="font-semibold text-lg text-gray-900">{partner.fullName}</h4>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-x-40 gap-y-3 text-sm text-gray-700 mb-3 w-full"> 
                    ...
                    {partner.area && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>{partner.area}, {partner.state}</span>
                      </div>
                    )}
      ...
      <div className="lg:hidden space-y-6">
          ...
          <Card className="shadow-xl border-0 bg-gradient-to-br from-white to-purple-50">
            ...
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label htmlFor="mobile-organizationName" className="text-sm font-semibold text-gray-700">
                    Organization Name
                  </Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="mobile-contactPerson" className="text-sm font-semibold text-gray-700">
                    Contact Person
                  </Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="mobile-type" className="text-sm font-semibold text-gray-700">
                    Partner Type
                  </Label>
                  <Select
                    value={formData.type}
                ...
                <div>
                  <Label htmlFor="mobile-areaOfCollaboration" className="text-sm font-semibold text-gray-700">
                    Area of Collaboration
                  </Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="mobile-termsSummary" className="text-sm font-semibold text-gray-700">
                    Terms Summary
                  </Label>
                  <Textarea
        ...
        <Card className="shadow-xl border-0 bg-gradient-to-br from-white to-orange-50">
          <CardHeader className="bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-t-lg">
            ...
            <CardDescription className="text-orange-100 text-sm">Tap to edit partners</CardDescription>
          </CardHeader>
            ...
            <div className="space-y-4">
              {loading ? (
                ...
                partners.map((partner) => (
                  <div key={partner._id} className="p-4 border-2 border-gray-200 rounded-lg bg-white">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="font-semibold text-base text-gray-900">{partner.fullName}</h4>
