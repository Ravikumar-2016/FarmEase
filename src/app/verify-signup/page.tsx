...
import { KeyRound, Loader2, CheckCircle, AlertCircle, Mail, Shield, Sparkles, ArrowRight, Sprout } from "lucide-react"
          ...
          <Card className="w-full max-w-md shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            <CardContent className="flex flex-col items-center justify-center p-12 space-y-6">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-xl font-bold text-slate-800">Loading Verification</h3>
                <p className="text-slate-600">Please wait while we prepare your verification...</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="w-full max-w-md shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader className="space-y-6 text-center pb-6">
              ...
              <div className="space-y-2">
                ...
                <CardDescription className="text-slate-600">
                  Your email has been successfully verified. Let&apos;s complete your account setup.
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-center space-x-3 p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-200">
                ...
                <span className="text-emerald-700 font-medium">Redirecting to account creation...</span>
              </div>
              <Button
                onClick={() => router.push(`/create-account?email=${encodeURIComponent(email)}`)}
                className="w-full h-12 bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 mt-2">Secure email verification</p>
        </div>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-xs text-slate-500 text-center">Enter the 6-digit code sent to your email address</p>
              </div>
