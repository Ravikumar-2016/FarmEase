      ...
      <section id="aboutus" className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <ul className="list-disc list-inside mb-6">
            <li>
              <strong>Innovation</strong>: We're dedicated to bringing you the latest advancements in agricultural
              technology.
            </li>
            <li>
              <strong>Sustainability</strong>: We promote farming practices that protect natural resources for future
              generations.
            </li>
            <li>
              <strong>Community</strong>: We believe in building strong relationships with the farming community and
              offering support every step of the way.
            </li>
            <li>
              <strong>Excellence</strong>: We are committed to quality and reliability in everything we do, from our
              products to our customer service.
            </li>
          </ul>
          {/* Add more content from the original HTML here */}
        </div>
      </section>
    )
  }
